...
Category.create(name: "COLOR, MY WORLD", round: 1)
Category.create(name: "PLANET FILL IN", round: 1)
Category.create(name: "MOVIE THEATER GIMMICKS", round: 1)
Category.create(name: '"LOVE"', round: 1)
Category.create(name: "HONOR", round: 1)
Category.create(name: "CHAIR-ISH", round: 1)

Category.create(name: "HISTORIC ILLINOIS", round: 2)
Category.create(name: "SHAKESPEARE PLAY SETTINGS", round: 2)
Category.create(name: "PHYSICS", round: 2)
Category.create(name: "COFFEE IS LIFE", round: 2)
Category.create(name: "10-, 11- & 12- LETTER WORDS", round: 2)
Category.create(name: "TV THEME LYRICS", round: 2)

Category.create(name: "AMERICA IN THE 19-AUGHTS", round: 3)
Category.create(name: "FAIRY TALES: A CLOSER LOOK", round: 3)
Category.create(name: "ORGANIZATIONS", round: 3)
Category.create(name: "ALSO A FACEBOOK REACTION", round: 3)
Category.create(name: "REALITY TV", round: 3)
Category.create(name: "GEOGRAPHIC IDIOMS", round: 3)
...
Clue.create(category_id: 1, value: 800, question: "IT'S A CITY IN NEW SOUTH WALES, A RIVER IN SOUTHERN AFRICA & A COUNTY IN SOUTHERN CALIFORNIA", answer: "WHAT IS ORANGE?")
...
Clue.create(category_id: 3, value: 200, question: "THE ODORAMA PROCESS ADDED SMELLS TO MOVIES USING THIS 3-WORD PROCESS THAT INVOLVES A CARD & YOUR FINGERNAIL", answer: "WHAT IS SCRATCH AND SNIFF?")
...
Clue.create(category_id: 3, value: 1000, question: "THIS DIRECTOR TOOK HIS \"JAY & SILENT BOB REBOOT\" ACROSS THE COUNTRY ON A ROADSHOW", answer: "WHO IS KEVIN SMITH?")
...
Clue.create(category_id: 4, value: 800, question: "A 1578 WORK SEEMS TO BE THE SOURCE OF THIS IDIOM THAT SAYS WHEN IT COMES TO ROMANCE & BATTLES, ANYTHING GOES", answer: "WHAT IS ALLS FAIR IN LOVE AND WAR?")
...
Clue.create(category_id: 6, value: 200, question: "NOT JUST ANY OLD ARMCHAIR, THE CORONATION CHAIR HAS BEEN USED SINCE THE 1300S & IS IN THIS LONDON ABBEY", answer: "WHAT IS WESTMINSTER ABBEY?")
...
Clue.create(category_id: 6, value: 600, question: "THIS \"B\"RAND OF RECLINING ARMCHAIRS GOES BACK TO 1940 & \"SCIENTIFICALLY ARTICULATED\" MOTION CHAIRS" , answer: "WHAT IS BARCALOUNGER?")
...
Clue.create(category_id: 7, value: 200, question: "THIS AMERICAN RETAILER OF GENERAL MERCHANDISE OPENED ITS FIRST STORE AT HOMAN AVENUE & ARTHINGTON STREET IN CHICAGO IN 1925", answer: "WHAT IS SEARS?")
...
Clue.create(category_id: 7, value: 600, question: "SETTLING IN ILLINOIS, HE FOUNDED HIS OWN DETECTIVE AGENCY & LATER HEADED THE UNION SECRET SERVICE DURING THE CIVIL WAR", answer: "WHO IS PINKERTON?")
Clue.create(category_id: 7, value: 800, question: "MORMON LEADER JOSEPH SMITH & HIS BROTHER HYRUM WERE KILLED BY A MOB IN 1844 IN THIS ILLINOIS CITY NAMED FOR AN ANCIENT CITY OF AFRICA" , answer: "WHAT IS CARTHAGE?")
Clue.create(category_id: 7, value: 1000, question: "AROUND 1673 THIS FRENCH JESUIT PRIEST EXPLORED THE REGION & TRAVELED ON THE ILLINOIS RIVER", answer: "WHO IS JACQUES MARQUETTE?")

Clue.create(category_id: 8, value: 200, question: "\"ROMEO & JULIET\", IS ONE OF THE PLAYS THAT TAKE PLACE IN WHAT'S NOW THIS COUNTRY", answer: "WHAT IS ITALY?")
Clue.create(category_id: 8, value: 400, question: "THIS TRAGEDY HAS SETTINGS IN ROME, SYRIA & FATEFULLY IN ALEXANDRIA, EGYPT", answer: "WHAT IS ANTONY AND CLEOPATRA?")
...
Clue.create(category_id: 10, value: 400, question: "A 1773 ACT & THIS FOLLOWING PROTEST PROMPTED MANY IN AMERICA TO TAKE UP COFFEE", answer: "WHAT IS THE BOSTON TEA PARTY?")
...
Clue.create(category_id: 12, value: 600, question: "\"IT SEEMS TODAY THAT ALL YOU SEE IS VIOLENCE IN MOVIES & SEX ON TV\"", answer: "WHAT IS FAMILY GUY?")
...
Clue.create(category_id: 13, value: 200, question: "THE 1906 HEPBURN ACT INCREASED FEDERAL RULE OVER THIS FORM OF TRANSPORTATION & SOME SAY CONTRIBUTED TO ITS EVENTUAL DECLINE", answer: "WHAT ARE RAILROADS?")
...
Clue.create(category_id: 13, value: 600, question: "THE CONSTITUTION OF THE LABOR UNION KNOWN AS THE WOBBLIES DECLARED THIS CLASS \"& THE EMPLOYING CLASS HAVE NOTHING IN COMMON\"", answer: "WHAT IS THE WORKING CLASS?")
Clue.create(category_id: 13, value: 800, question: "ATTORNEY GENERAL & EMPEROR'S GRAND-NEPHEW CHARLES BONAPARTE WANTED HIS OWN CREW OF AGENTS, CREATING WHAT'S NOW THIS IN 1908", answer: "WHAT IS THE FBI?")
...
Clue.create(category_id: 14, value: 200, question: "A SWAN OVERCOMES A CASE OF MISTAKEN SELF-IDENTITY & SERIOUS SELF-LOATHING", answer: "WHAT IS THE UGLY DUCKLING?")
...
Clue.create(category_id: 14, value: 600, question: "A WILD ANIMAL WHO'S PRETTY GOOD AT DECEPTION ATTEMPTS 2 HOMICIDES, THAT OF A GIRL & HER GRANDMOTHER, BUT ENDS UP DEAD", answer: "WHAT IS LITTLE RED RIDING HOOD?")
Clue.create(category_id: 14, value: 800, question: "A WOMAN'S ROYAL LINEAGE IS DETERMINED USING BEDDING TO REVEAL HER DEMANDING NATURE & SENSE OF PRIVILEGE", answer: "WHAT IS THE PRINCESS AND THE PEA?")
Clue.create(category_id: 14, value: 1000, question: "AN ANTHROPOMORPHIC CAT WITH AN INTERESTING FASHION SENSE MURDERS RABBITS, KILLS AN OGRE & STEALS LAND FOR HIS FRIEND", answer: "WHAT IS PUSS IN BOOTS?")

Clue.create(category_id: 15, value: 200, question: "WORKING TO END HUNGER, THE FOOD & AGRICULTURE ORGANIZATION IS THE OLDEST SPECIALIZED AGENCY FOUNDED BY THIS BODY", answer: "WHAT IS THE UNITED NATIONS?")
...
Clue.create(category_id: 17, value: 200, question: "WE KEPT UP WITH THIS FAMILY FOR 14 YEARS, BUT IN 2021 KIM, KHLOE & KOMPANY BID FAREWELL AS THEIR SHOW CAME TO AN END", answer: "WHO ARE THE KARDASHIANS?")
...
Clue.create(category_id: 17, value: 600, question: "ACCORDING TO THE TITLE OF THEIR LONG-RUNNING HGTV SERIES, DREW & JONATHAN SCOTT ARE THESE SIBLINGS", answer: "WHO ARE THE PROPERTY BROTHERS?")
Clue.create(category_id: 17, value: 800, question: "HE'S MADE THE ROUNDS ON REALITY TV BEGINNING WITH \"QUEER EYE\" & MORE RECENTLY, AS A JUDGE ON RUPAUL'S DRAG RACE", answer: "WHO IS CARSON KRESSLEY?")
...
Clue.create(category_id: 18, value: 200, question: "IF YOU'RE BETWEEN A ROCK & A HARD PLACE, YOU MIGHT ALSO BE BETWEEN THE DEVIL & THIS SALTY EXPANSE", answer: "WHAT IS THE DEEP BLUE SEA?")
...
Clue.create(category_id: 18, value: 800, question: "THE ATLANTIC GETS DOWNGRADED IN THIS SLANGY EXPRESSION FOR TRAVELING BETWEEN THE UNITED KINGDOM & THE UNITED STATES", answer: "WHAT IS THE POND?")
